...
def test_labels():
    assert lookup('utf-8').gl_name == 'utf-8'
    assert lookup('Utf-8').gl_name == 'utf-8'
    assert lookup('UTF-8').gl_name == 'utf-8'
    assert lookup('utf8').gl_name == 'utf-8'
    assert lookup('utf8').gl_name == 'utf-8'
    assert lookup('utf8 ').gl_name == 'utf-8'
    assert lookup(' \r\nutf8\t').gl_name == 'utf-8'
    ...
    assert lookup('US-ASCII').gl_name == 'windows-1252'
    assert lookup('iso-8859-1').gl_name == 'windows-1252'
    assert lookup('latin1').gl_name == 'windows-1252'
    assert lookup('LATIN1').gl_name == 'windows-1252'
...
def test_all_labels():
    ...
    for name in set(LABELS.values()):
        assert lookup(name).gl_name == name
